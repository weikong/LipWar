...
public abstract class ActivityUiRecog extends ActivityCommon implements IStatus {
    ...
    public ActivityUiRecog(int textId) {
        ...
        if (className.equals("ActivityOnlineRecog") || className.equals("ActivityUiDialog") || className.equals("ActivityRegTranslateDialog")) {
